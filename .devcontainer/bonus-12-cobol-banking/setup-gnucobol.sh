...
echo ""
echo "To compile and run the banking system:"
echo "  cd $CHALLENGE_DIR"
echo ""
echo "  # 1. Compile and run the initializer (creates seed data)"
echo "  cobc -x -free programs/BNKINIT.cbl"
echo "  ./BNKINIT"
echo ""
echo "  # 2. Compile the main app with all modules linked"
echo "  cobc -x -free programs/BNKMAIN.cbl \\"
echo "      programs/BNKAUTH.cbl programs/BNKCUST.cbl \\"
echo "      programs/BNKACCT.cbl programs/BNKTXN.cbl \\"
echo "      programs/BNKLOAN.cbl programs/BNKINTR.cbl \\"
echo "      programs/BNKBATCH.cbl programs/BNKRPT.cbl \\"
echo "      programs/BNKAUDT.cbl programs/BNKUTIL.cbl"
echo "  ./BNKMAIN"
echo ""
